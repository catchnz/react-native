...
//av2 changed: const currentCommit = exec(`git rev-parse HEAD`, {silent: true}).stdout.trim();
//added
const currentCommit = "[, refs/heads/0.35-stable, refs/tags/latest, refs/tags/v0.35.0, refs/tags/v0.35-rc]";

// [34c034298dc9cad5a4553964a5a324450fda0385, refs/heads/0.33-stable, refs/tags/latest, refs/tags/v0.33.1, refs/tags/v0.34.1-rc]
//av2 changed: const tagsWithVersion = exec(`git ls-remote origin | grep ${currentCommit}`, {silent: true}).stdout.split(/\s/)
//added
const tagsWithVersion = "[, refs/heads/0.35-stable, refs/tags/latest, refs/tags/v0.35.0, refs/tags/v0.34.0-rc]"
  .split(/\s/)
...
//av2 changed:
//commented out to not use javadocs
//av2 could not get jdk7
